...
// void loop () {
//     Serial.println('Data from Arduino is here');
//     delay(1000);
// }
...
void setup(void) {
  ...
  // large block of text
  tft.fillScreen(ST77XX_BLACK);
  testdrawtext("Maecenas enim massa, fringilla sed malesuada et, malesuada sit amet turpis. Sed porttitor neque ut ante pretium vitae malesuada nunc bibendum. Nullam aliquet ultrices massa eu hendrerit. Ut sed nisi lorem. In vestibulum purus a tortor imperdiet posuere. ", ST77XX_WHITE);
  delay(1000);
